        ...
        <div class="card">
          <div id="profilecard" class="card-body">
            ...
            <div id='userInfo'>
              ...
              <p>Password: ********* <button id="button1" onclick="openChange()"
                  class="btn btn-danger ms-2">Change</button></p>
            </div>

            <form action="" method="POST" id="pwd_chng" style="display: none">
              <p>Old password: <input name="old_pwd" type="text" /></p>
              <p>New password:<input name="new_pwd" type="text" /><button type="submit" name="submit"
                  class="btn btn-danger ms-2">Submit</button><button onclick="closeChange()"
                  class="btn btn-danger ms-2">Cancel</button></p>
            </form>
            <p id="chng_msg"></p>
            <br>
          </div>
